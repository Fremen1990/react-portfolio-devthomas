export const messages = {
  ...
  orange: {
    ...
    description:
      "Working on two projects, first one TV streaming platform, where I am responsible for front end development, using React JS and TypeScript. Second one as front-end owner of internal CMS project. I am also responsible for creating and maintaining unit & E2E tests for front end code.",
    techStack:
      "React JS, TypeScript, React Query, Cypress, GitLab, Jira, Confluence",

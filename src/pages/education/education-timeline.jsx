...
import {EducationDetailsKursReacta, EducationDetailsMegaK, messages} from "./messages";
            ...
            <Timeline>
                <Events>
                    ...
                    <EducationCard
                        ...
                        techStackList={
                            messages.Udemy.techStack.map((tech, index) => (
                                <TechImage
                                    key={index}
                                    title={tech.name}
                                    image={tech.image}
                    ...
                    <EducationCard
                        ...
                        details={<EducationDetailsMegaK/>}
                        techStackList={
                            messages.MegaK.techStack.map((tech, index) => (
                                <TechImage
                                    key={index}
                                    title={tech.name}
                                    image={tech.image}
                    ...
                    <EducationCard
                        ...
                        techStackList={
                            messages.KursReacta.techStack.map((tech, index) => (
                                <TechImage
                                    key={index}
                                    title={tech.name}
                                    image={tech.image}
                    ...
                    >
                        <div className="d-flex justify-content-between flex-column mt-1">
                                ...
                                <Accordion>
                                    <Card>
                                        ...
                                        <Accordion.Collapse eventKey="0" className="text-left">
                                            <Card.Body>
                                                <strong>Description:</strong> Pluralsight is an online
                                                learning and workforce development platform that helps
                                                businesses and individuals adjust to changing
                                                technology. Using a data-driven approach, the platform
                                                focuses on training for tech-based professions, such as
                                                IT operations, security and software development, as
                                                well as leadership, including managers and product
                                                leaders.
                                                <hr/>
                                                <div className="row h-25">
                                                    <strong className="col-8 h3">
                                                        Role IQ Assessments:{" "}
                                                    </strong>
                                                    <br/>
                                                    <br/>
                            ...
                            <div className="d-flex justify-content-between flex-nowrap text-center">
                                <UrlButton
                                    href="https://www.youtube.com/watch?v=h_wPDVn2nfg"
                                    target="_blank"
                                >
                                    Pluralsight Promo
                                </UrlButton>

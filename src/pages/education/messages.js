...
import U_REACT_ADVANCED_PATTERNS
    from "../../assets/img/education/udemy_courses/The Complete Guide to Advanced React Component Patterns.jpg";
import C_REACT_ADVANCED_PATTERNS
    from "../../assets/Programming Certificates/The Complete Guide to Advanced React Component Patterns.pdf";
import U_POLYMORPHIC_COMPONENTS
    from "../../assets/img/education/udemy_courses/Build Polymorphic Components with React and Typescript.jpg";
import C_POLYMORPHIC_COMPONENTS
    from "../../assets/Programming Certificates/Build Polymorphic Components with React and TypeScript.jpg";
...
import U_HOW_TO_BECOME_SENIOR
    from "../../assets/img/education/udemy_courses/How to Become a Senior Developer - Beyond coding skills.jpg";
import C_HOW_TO_BECOME_SENIOR
    from "../../assets/Programming Certificates/How to Become a Senior Developer - Beyond coding skills.pdf";
import U_SOFTWARE_DEVELOPMENT_MINDSETS
    from "../../assets/img/education/udemy_courses/Software Development Mindsets For Successful Career.jpg";
import C_SOFTWARE_DEVELOPMENT_MINDSETS
    from "../../assets/Programming Certificates/Software Development Mindsets For Successful Career.pdf";
...
import U_AWS_LAMBDA
    from "../../assets/img/education/udemy_courses/AWS Lambda and the Serverless Framework - Hands On Learning.jpg";
import C_AWS_LAMBDA
    from "../../assets/Programming Certificates/AWS Lambda and the Serverless Framework - Hands On Learning.pdf";
import U_FACEBOOK_CLONE
    from "../../assets/img/education/udemy_courses/Build Facebook clone with REACT JS AND THE MERN STACK 2023.jpg";
import C_FACEBOOK_CLONE
    from "../../assets/Programming Certificates/Build Facebook clone with REACT JS AND THE MERN STACK 2022.pdf";
import U_RTL
    from "../../assets/img/education/udemy_courses/The React Testing Library Bootcamp - The Developer Guide.jpg";
import C_RTL from "../../assets/Programming Certificates/The React Testing Library Bootcamp - The Developer Guide.pdf";
import U_CSS_ANIMATION
    from "../../assets/img/education/udemy_courses/Next Level CSS Creative Hover & Animation Effects.jpg";
import C_CSS_ANIMATION
    from "../../assets/Programming Certificates/The React Testing Library Bootcamp - The Developer Guide.pdf";
import U_NEST_JS
    from "../../assets/img/education/udemy_courses/Opanuj NestJS i zostań profesjonalnym programistą NodeJS.jpg";
import C_NEST_JS
    from "../../assets/Programming Certificates/The React Testing Library Bootcamp - The Developer Guide.pdf";
import U_MERN_ECOMMERCE
    from "../../assets/img/education/udemy_courses/MERN Stack React Node Ecommerce from Scratch to Deployment.jpg";
import C_MERN_ECOMMERCE
    from "../../assets/Programming Certificates/The React Testing Library Bootcamp - The Developer Guide.pdf";
import U_REACT_TESTING_FOR_ENGINEERS
    from "../../assets/img/education/udemy_courses/Testing react applications for professional engineers.jpg";
import C_REACT_TESTING_FOR_ENGINEERS
    from "../../assets/Programming Certificates/Testing react applications for professional engineers.jpg";
import U_ADVANCED_REACT_ENTERPRISE
    from "../../assets/img/education/udemy_courses/Advanced React For Enterprise React for senior engineers.jpg";
import C_ADVANCED_REACT_ENTERPRISE
    from "../../assets/Programming Certificates/Testing react applications for professional engineers.jpg";
import {allSkillsArray, getSkillsByEducationName} from "../../utils/getSkills";
